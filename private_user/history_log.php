...
<head>
  ...
  <title>Nukah Gps File Management System</title>
  <!-- Icon -->
  <link rel="shortcut icon" type="x-icon" href="nukah.png">
  <!-- Font Awesome -->
...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
  ...
  <!--Navbar -->
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark color grey fixed-top">
    <a class="navbar-brand" href="#"><img src="js/img/nukah.png" width="100px" height="85px">
      <font color="white">F</font>ile <font color="white">M</font>anagement <font color="white">S</font>ystem
    </a>
      ...
      <div class="col-md-3" style="border-top: 4px solid #17a2b8;border-radius: 4px;  box-shadow: 0px 1px 1px 0px  #6c757d;"><br>
        ...
        <div class="tab-content pt-2 pl-1" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <img src="js/img/profile.png" class="rounded" alt="...">
            <hr>
            <!--
    <div class="">
...
!-->
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
          <h6 style="font-size: 1.1em">Complete File management system (fMS)</h6>
          <Hr>
        ...
        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
          ...
          <Hr><br>
          <div class="">
            <p><b style="font-size: 1.1em">Cellphone #:</b>+639079373999</p>
          </div>
