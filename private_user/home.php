...
<head>
  ...
  <title>Nukah Gps File Management System</title>
   ...
   <!-- Icon -->
   <link rel="shortcut icon" type="x-icon" href="js/img/nukah.png">
  <!-- Font Awesome -->
...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
  ...
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark color grey fixed-top">
    <a class="navbar-brand" href="#"><img src="js/img/nukah.png" width="100px" height="100px">
...
!-->
          ...
          <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            ...
            <Hr><br>
            <div class="">
              <p><b style="font-size: 1.1em">Cellphone #:</b>0990319276</p>
            </div>
            <p><b style="font-size: 1.1em">Address :</b>Malawi</p>
          </div>
          <hr><br>
          <!--   <div class="card">
