...
<head>
  ...
  <title>Nukah Gps Tech File Management </title>
  <!-- Font Awesome -->
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <img src="img/nukah.png" width="150px" height="200px;" class="img-fluid" alt="">
      </a>
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
      ...
      <div class="">
        ...
        <!--   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegisterForm">Create Folder </button> -->
        <a href="add_folder.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Create Folder </button></a>
      </div>
...
window._conf = function($msg='',$func='',$params = []){
  ...
  $(document).ready(function(){
    ...
    <div class="footer-copyright py-3">
      <p>All right Reserved &copy; <?php echo date('Y'); ?> Created By:Tinashe & Juma</p>
    </div>
    <!--/.Copyright-->
