...
/*This  section has been commented out so that we can be able to access this page while 
I work on adding it through authentication
...
<head>
  ...
  <title>Nukah Gps Tech</title>
   <!-- Icon -->
   <link rel="shortcut icon" type="x-icon" href="img/nukah.png">
  <!-- Font Awesome -->
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <div class="d-flex justify-content-center pull-right">
            ...
            <a href="home.php">
            <button class="btn btn-warning pull-right"><i class="far fa-file-image"></i>  View Folders</button></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Create Folders</h4>
...
<!-- Material form login -->
 ...
 <p>All right Reserved 2021&copy; <?php echo date('Y');?> Created By: Juma</p>
    </div>
    <!--/.Copyright-->
